/**
 * Canonical allowlist of adapter IDs recognized by the PromptProfit system.
 *
 * Rules:
 ...
 * - Add new IDs here AND update the Zod enum in packages/shared/src/schemas/events.ts.
 */
...
export const BROWSER_ADAPTER_IDS = [
  ...
  "browser_claude",  // Claude.ai — structural DOM wait-state detection
  "browser_gemini",  // Gemini.google.com — structural DOM wait-state detection
...
/** Maps an adapter ID to its broad platform category */

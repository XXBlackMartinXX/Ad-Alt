...
console.log('     The tester MUST be logged into chatgpt.com.');
...
console.log('     IMPORTANT: the demo banner now appears within a few seconds of the');
console.log('     chatgpt.com page loading -- BEFORE any prompt is sent. It no longer');
console.log('     depends on ChatGPT actually generating a response. This is the');
console.log('     deterministic internal-beta forced demo fallback -- see');
console.log('     docs/internal-beta/dry-runs/DRYRUN-001_DEFINITIVE_BANNER_FIX.md.');
...
console.log('     The banner stays visible for at least ~12 seconds unless dismissed.');
console.log('     If it does NOT appear within a few seconds of page load: check the');
console.log('     internal-beta live dry-run diagnostics panel (top-left corner) for its');
console.log('     exact status line -- do not guess at a cause.');
console.log('');

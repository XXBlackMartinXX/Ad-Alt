# Gemini Browser — Assisted Manual Live Verification Result

> **Template.** Copy this file to
> `GEMINI_ASSISTED_LIVE_VERIFICATION_RESULT_LOG.md` in this same
> directory and fill it in after completing
> `GEMINI_ASSISTED_MANUAL_LIVE_VERIFICATION_RUNBOOK.md`. Read
...
do not repeat it here, and never record Gemini's actual response text.

# Claude Browser — No-Login Live Smoke Result

> **Template.** Copy this file to `CLAUDE_NO_LOGIN_LIVE_SMOKE_RESULT_LOG.md`
> in this same directory and fill it in after running
> `CLAUDE_NO_LOGIN_LIVE_SMOKE_RUNBOOK.md`. Read

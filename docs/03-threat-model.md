...
> **Historical naming note:** Authored under the original working name **"Ad-Alt,"** since rebranded **PromptProfit**. Read "Ad-Alt" below as "PromptProfit." Retained verbatim for historical record; the GitHub repository name `Ad-Alt` is unrelated and unchanged.

 ...
 *
 * Uses GeminiAdapter for wait-state detection and sponsored moment rendering,
 ...
 * revenue pilot's dry-run deterministic; Gemini is not part of that pilot
 * and must not affect it).
 *
 * SUPPORT STATUS: beta (fixture-tested + unit-tested; no human-operated
 * live-session confirmation yet — see
 * docs/internal-beta/platforms/GEMINI_BROWSER_VERIFICATION.md). Gemini stays
 ...
 * gemini.selectors.ts. All telemetry contains only backend-assigned

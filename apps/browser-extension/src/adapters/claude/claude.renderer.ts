/**
 * Claude sponsored moment renderer.
 *
 ...
 * page's CSS. Structurally identical to ChatGPTRenderer — kept as a
 * separate per-platform file (rather than shared) so future platform-
 * specific positioning/styling needs do not require touching the ChatGPT
 * renderer.
 *
...
export interface IClaudeRenderer {
  /**
...
export class ClaudeRenderer implements IClaudeRenderer {
